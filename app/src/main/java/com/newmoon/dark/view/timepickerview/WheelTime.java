...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear), false);// 设置"年"的显示数据
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据

        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        wv_month.setAdapter(new NumericWheelAdapter(1, 12), true);
...
//        }
        ...
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23), false);
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);

        wv_mins = (WheelView) view.findViewById(R.id.min);
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59), false);
        //wv_mins.setLabel(context.getString(R.string.time_minute_single));// 添加文字
        ...
        OnItemSelectedListener wheelListener_year = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (list_big
                    ...
                    if (type == TimePickerView.Type.MONTH_DAY) {
                        wv_day.setAdapter(new NumericWheelAdapter(1, 29), false);
                        maxItem = 29;
                    } else {
        ...
        OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (dayCurrentItem > maxItem - 1) {
                    wv_day.setCurrentItem(maxItem - 1);
                } else {
                    wv_day.setCurrentItem(dayCurrentItem);
                }
