...
package com.newmoon.dark.wallpaper.crop;
...
public class CropOverlayView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (CropImageOptions.DEBUG) {
            Log.d(CropImageOptions.TAG, "action " + event.getAction() + " x " + event.getX() + " y " + event.getY());
        }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (CropImageOptions.DEBUG) {
                Log.i("ScaleListener", "newTop " + newTop + " newLeft " + newLeft + " newRight " + newRight + " newBottom " + newBottom);
                Log.i("ScaleListener", "left " + left + " top " + top + " right " + right + " bottom " + bottom);
            }
            if (newLeft < newRight &&
                    newTop <= newBottom &&
                    newLeft >= 0 &&
